...
class alipay{
    ...
    public function get_payurl(){
    	...
    	$this->parameter = array(
            ...
            'notify_url'	    => "http://www.zhifu.com/index.php/Home/Index/notify_url",	//异步通知URL
            // 'notify_url' => "/ThinkPHP/Library/Think/alipay/notify_url.php",
            // 'return_url' => "/ThinkPHP/Library/Think/alipay/return_url.php",
            'sign_type'		    => 'MD5',				//签名方式
            'return_url'	    => "http://www.zhifu.com/index.php/Home/Index/return_url",	//返回URL
